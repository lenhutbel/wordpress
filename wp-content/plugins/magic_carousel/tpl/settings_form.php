<div class="wrap">
  ...
  <form method="POST" enctype="multipart/form-data">
    ...
    <div style="text-align:center; padding:0px 0px 20px 0px;"><img src="<?php echo plugins_url('images/icons/magnifier.png', dirname(__FILE__))?>" alt="add" align="absmiddle" /> <a href="javascript: void(0);" onclick="showDialogPreview(<?php echo strip_tags($_SESSION['xid'])?>)">Preview</a></div>
...
<div id="accordion">
  ...
  <div style="padding:30px;">
	  <table class="wp-list-table widefat fixed pages" cellspacing="0">
		...
		<tr>
            <td width="30%" align="right" valign="top" class="row-title">Image Width</td>
		    <td width="75%" align="left" valign="top"><input name="imageWidth" type="text" size="25" id="imageWidth" value="<?php echo $_POST['imageWidth'];?>"/></td>
	    </tr>
		  <tr>
		    <td align="right" valign="top" class="row-title">Image Height</td>
		    <td align="left" valign="top"><input name="imageHeight" type="text" size="25" id="imageHeight" value="<?php echo $_POST['imageHeight'];?>"/></td>
	    </tr>
        <tr>
        ...
        <tr>
			...
			<tr>
			<td align="right" valign="top" class="row-title">Center Plugin</td>
		  ...
		  <tr>
		    <td align="right" valign="top" class="row-title">Title Color</td>
		    <td align="left" valign="top"><input name="titleColor" type="text" size="25" id="titleColor" value="<?php echo strip_tags($_POST['titleColor']);?>" style="background-color:#<?php echo strip_tags($_POST['titleColor']);?>" />
                <script>
...
.bind('keyup', function(){
	jQuery(this).ColorPickerSetColor(this.value);
              ...
              </script>            click to select the color or just write: transparent</td>
	      </tr>
		  <tr>
        ...
        <tr>
		    <td align="right" valign="top" class="row-title">Border Color OFF State</td>
...
.bind('keyup', function(){
	jQuery(this).ColorPickerSetColor(this.value);
              ...
              </script>            select the color or just write: transparent</td>
	    </tr>
		<tr>
		    <td align="right" valign="top" class="row-title">Border Color ON State</td>
...
.bind('keyup', function(){
	jQuery(this).ColorPickerSetColor(this.value);
		  ...
		  <tr>
		    <td align="right" valign="top" class="row-title">LightBox Window Width Divider</td>
		    <td align="left" valign="middle"><input name="lightbox_width_divider" type="text" size="25" id="lightbox_width_divider" value="<?php echo $_POST['lightbox_width_divider'];?>"/></td>
	      </tr>
		  <tr>
		    <td align="right" valign="top" class="row-title">LightBox Window Height Divider</td>
		    <td align="left" valign="middle"><input name="lightbox_height_divider" type="text" size="25" id="lightbox_height_divider" value="<?php echo $_POST['lightbox_height_divider'];?>"/></td>
	      </tr>
		  <tr>
